...
[GitHub Releases](https://github.com/dinhno12313/CCShortcutLauncher/releases/tag/v1.4.4).
...
```sh
sudo dpkg -i '/var/mobile/com.dinhnguyenx.ccshortcutlauncher_1.4.4_iphoneos-arm64.deb'
sudo sbreload
```
